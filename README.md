The code is used to detect certain trends of wildfire gasses in the past 2 decades. This specific project uses CO data from giovanni databases to formulate analytical 
